...
@Slf4j
public class LessThanOrEqualToOfInteger extends Operator<Boolean> {

    public static LessThanOrEqualToOfInteger of(String name, Object value) {
        LessThanOrEqualToOfInteger node = new LessThanOrEqualToOfInteger();
        node.setName(name);
        node.setValue(value);

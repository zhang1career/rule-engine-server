...
public class RecursiveCalculateServiceImplTest {
    ...
    public void test_calculate_instant() throws Exception {
        ...
        ExpressionMeta<Integer> expressionMeta = new ExpressionMeta<>();
        expressionMeta.setTreeNode(node0);
        Context context = new Context();
        // execute
        Integer result = calculateServiceForInt.calculate(expressionMeta, context);
        // verify
    ...
    public void test_calculate_variable_integer() throws Exception {
        ...
        ExpressionMeta<Integer> expressionMeta = new ExpressionMeta<>();
        expressionMeta.setTreeNode(nodeAge);
        Context context = new Context();
        context.putParam(paramAge, param18);
        // execute
        Object result = calculateServiceForInt.calculate(expressionMeta, context);
        // verify
    ...
    public void test_calculate_operation() throws Exception {
        ...
        ExpressionMeta<Boolean> expressionMeta = new ExpressionMeta<>();
        expressionMeta.setTreeNode(nodeGt);
        Context context = new Context();
        context.putParam(paramAge, param20);
        // execute
        Boolean result = calculateServiceForBool.calculate(expressionMeta, context);
        // verify
